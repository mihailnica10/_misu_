...
import type { MisuChat, MisuMessage } from "@/app/components/shared/types";
...
interface ChatHistoryContextType {
    ...
    newChatMessages: MisuMessage[] | null;
    setNewChatMessages: (messages: MisuMessage[] | null) => void;
    replaceChatId: (
        oldChatId: string,
        newChatId: string,
        title?: string,
...
export function ChatHistoryProvider({ children }: { children: ReactNode }) {
    const { user } = useAuth();
    const [chats, setChats] = useState<MisuChat[] | null>(null);
