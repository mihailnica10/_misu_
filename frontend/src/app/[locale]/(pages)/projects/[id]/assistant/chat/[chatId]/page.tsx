...
export default function ProjectAssistantChatPage({ params }: Props) {
    ...
    const [initialMessages] = useState<MisuMessage[]>(newChatMessages ?? []);
    ...
    const handleDocClick = (doc: MisuDocument) => {
        openTab(doc.id, doc.filename);
    };

    const handleCitationClick = (citation: MisuCitationAnnotation) => {
        openTab(
    ...
    const handleEditViewClick = (ann: MisuEditAnnotation, filename: string) => {
                            ...
                            onDragOver={(e) => {
                                ...
                                const isInternal =
                                    Array.from(e.dataTransfer.types).includes(
                                        "application/misu-doc",
                                    ) ||
                                    Array.from(e.dataTransfer.types).includes(
                                        "application/misu-folder",
                                    );
