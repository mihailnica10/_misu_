...
import { getWorkflow, updateWorkflow } from "@/app/lib/misuApi";
...
import type { ColumnConfig, MisuWorkflow } from "@/app/components/shared/types";
import {
    BUILT_IN_IDS,
    BUILT_IN_WORKFLOWS,
...
export default function WorkflowDetailPage({ params }: Props) {
    ...
    const [workflow, setWorkflow] = useState<MisuWorkflow | null>(null);
