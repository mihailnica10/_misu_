...
export default function SignupPage() {
    ...
    const { isAuthenticated, authLoading, signup } = useAuth();
    ...
    useEffect(() => {
        if (!authLoading && isAuthenticated) {
            ...
            window.location.href = `/${locale}/assistant`;
        }
                ...
                <div className="w-full max-w-md">
                    <div className="bg-white border border-gray-200 rounded-2xl p-8">
                        ...
                        <div className="mt-4 text-center text-xs text-gray-500">
                            {t("terms_prefix")}{" "}
                            <Link
                                href={`${typeof window !== "undefined" ? window.location.origin : "https://misu.ro"}/terms`}
                                target="_blank"
                            ...
                            {t("and")}{" "}
                            <Link
                                href={`${typeof window !== "undefined" ? window.location.origin : "https://misu.ro"}/privacy`}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-blue-600 hover:underline"
                            >
