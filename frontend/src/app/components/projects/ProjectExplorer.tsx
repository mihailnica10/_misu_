...
import type { MisuDocument, MisuFolder } from "@/app/components/shared/types";
...
interface Props {
    ...
    onDocClick: (doc: MisuDocument) => void;
...
export function ProjectExplorer({
    ...
    async function handleDropOnTarget(targetFolderId: string | null, e: React.DragEvent) {
        const docId = e.dataTransfer.getData("application/misu-doc");
        const movingFolderId = e.dataTransfer.getData("application/misu-folder");
    ...
    function isInternalDrag(e: React.DragEvent): boolean {
        return (
            Array.from(e.dataTransfer.types).includes("application/misu-doc") ||
            Array.from(e.dataTransfer.types).includes("application/misu-folder")
        );
    }
