...
import type { MisuDocument, MisuWorkflow } from "../shared/types";
import { createTabularReview } from "@/app/lib/misuApi";
import { useRouter } from "next/navigation";
import { formatIcon, formatLabel } from "../tabular/columnFormat";
import { useDirectoryData } from "../shared/useDirectoryData";
import { FileDirectory } from "../shared/FileDirectory";
import type { MisuProject } from "../shared/types";
import { useChatHistoryContext } from "@/app/contexts/ChatHistoryContext";

interface Props {
    workflows: MisuWorkflow[];
    workflow: MisuWorkflow | null;
    onClose: () => void;
}
...
// ---------------------------------------------------------------------------
function AssistantPanel({ workflow }: { workflow: MisuWorkflow }) {
    return (
...
// ---------------------------------------------------------------------------
function TabularPanel({ workflow }: { workflow: MisuWorkflow }) {
...
export function DisplayWorkflowModal({ workflows, workflow, onClose }: Props) {
    ...
    const [selected, setSelected] = useState<MisuWorkflow | null>(workflow);
